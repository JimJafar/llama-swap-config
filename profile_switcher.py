...
class App(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        try:
            ...
            commands = {'27b': [str(SCRIPT), '27b'], 'dflash2': [str(SCRIPT), 'dflash2'], 'flash': [str(SCRIPT), 'flash']}
